...
class App(Frame):
    ...
    def __createSecondaryModeWidget(self, mode_str):
        ...
        self.secondary_mode_option = Button(root, text="Choose Image", command=lambda: _choose_color())
    ...
    def __updateSecondaryModeWidget(self, mode_str):
        ...
        if mode_str == 'normal':
            ...
            self.secondary_mode_option = Button(root, text="Select color", command=lambda: _choose_color())
